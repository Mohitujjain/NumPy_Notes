...
This allows the code to be optimized even further.To work with ndarrays, we need to load the numpy library. It is standard practice to load numpy with the alias "np" like so:
"""
